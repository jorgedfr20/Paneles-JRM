...
def optimizar_paneles(demanda1, demanda2, demanda3,
                     ...
                     horas_sol=4.5):
    """
    Optimiza la cantidad de paneles solares para 3 casas minimizando el costo.
    ...
    # Resultados
    resultados = {
        "Casa 1": {"A": A1.varValue, "B": B1.varValue, "C": C1.varValue},
        "Casa 2": {"A": A2.varValue, "B": B2.varValue, "C": C2.varValue},
        "Casa 3": {"A": A3.varValue, "B": B3.varValue, "C": C3.varValue},
